...
namespace ReadyApi.Model.UnitTest.CustomExceptionTest
{
    ...
    {
        [Test]
        public void ReadyApi_Model_UnitTest_CustomExceptionTest__FriendlyExceptionCreation_WithMessage()
        {
        ...
        [Test]
        public void ReadyApi_Model_UnitTest_CustomExceptionTest__FriendlyExceptionCreation_WithMessageAndException()
        {
